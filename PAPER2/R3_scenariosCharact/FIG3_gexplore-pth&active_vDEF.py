...
##       FIGURE     ##################
sp_titles = ["", "Scenario 1", "Scenario 2", "Scenario 3", "Scenario 4"] + [""]*5*3
...
pio.write_html(fig, file=folder + "/PAPER3_g_explore.html", auto_open=True, include_mathjax="cdn")
pio.write_image(fig, file=folder + "/PAPER3_g_explore.svg", engine="kaleido")
