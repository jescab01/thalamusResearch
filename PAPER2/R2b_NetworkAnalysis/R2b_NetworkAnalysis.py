...
# Load structures
conn = connectivity.Connectivity.from_file("E://LCCN_Local/PycharmProjects/CTB_data3/NEMOS_AVG_AAL2pTh_pass.zip")
...
# pio.write_html(fig, file=folder + '/Network_metrics_pass.html', auto_open=True)
# pio.write_image(fig, file=folder + '/Network_metrics_pass.png')
#
#
